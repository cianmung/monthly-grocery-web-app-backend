          ...
          <div className="payment-summary-container">
            <div className="payment-summary-header">
              <div className="ui tiny blue statistic">
                ...
                <div className="value">${totalPayment.toFixed(2)}</div>
              </div>
              <div className="ui tiny blue statistic">
                <div className="label">Each</div>
                <div className="value">${eachPayment.toFixed(2)}</div>
              </div>
            </div>
                        ...
                        <div className="content">
                          <div className="summary">
                            ...
                            <p className="summary-footer">
                              <span>
                                <span style={{ color: "#2185d0" }}>Paid</span> :{" "}
                                {each.amount.toFixed(2)} SGD
                              </span>{" "}
                              <span>
                                <span style={{ color: "#2185d0" }}>
                                  {each.amount - eachPayment > 0
                                    ? "Receive"
                                    : "Pay"}
                                </span>{" "}
                                : {(each.amount - eachPayment).toFixed(2)} SGD
                              </span>
                            </p>
                          </div>
                        </div>
